...
export const siteSettings = pgTable("site_settings", {
  ...
  colorCardBorder: text("color_card_border").notNull().default("#e2e2e2"),
  colorCardAccent: text("color_card_accent").notNull().default("#981e32"),
  colorCardTitle: text("color_card_title").notNull().default("#393939"),
  ...
  cardPaddingPx: integer("card_padding_px").notNull().default(20),
